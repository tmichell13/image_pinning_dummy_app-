...
const randomImg = 'https://source.unsplash.com/1600x900/?nature,photography,technology,movies'
...
const UserProfile = () => {
  ...
  function handleSignOut() {
    localStorage.clear() // FIXME: there has to be a correct way to logout of google OAuth 2.0
    navigate('/Login')
  }
        ...
        <div className='relative flex flex-col mb-7'>
          ...
          <div className='text-center mb-7'>
            <button
              type='button'
              onClick={(e) => {
                setText((e.target as HTMLTextAreaElement).textContent)
